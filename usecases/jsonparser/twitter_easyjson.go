...
func easyjsonE23b537bDecodeGithubComTsukiyozDemosUsecasesJsonparser(in *jlexer.Lexer, out *Twitter) {
	...
	for !in.IsDelim('}') {
		...
		case "search_metadata":
			easyjsonE23b537bDecode(in, &out.SearchMetadata)
		case "statuses":
			if in.IsNull() {
				in.Skip()
				out.Statuses = nil
...
func easyjsonE23b537bEncodeGithubComTsukiyozDemosUsecasesJsonparser(out *jwriter.Writer, in Twitter) {
	out.RawByte('{')
	first := true
	_ = first
	{
		...
		easyjsonE23b537bEncode(out, in.SearchMetadata)
	}
	{
		...
		if in.Statuses == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v2, v3 := range in.Statuses {
				...
				easyjsonE23b537bEncode1(out, v3)
			}
			out.RawByte(']')
		}
	}
...
func (v Twitter) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE23b537bEncodeGithubComTsukiyozDemosUsecasesJsonparser(&w, v)
...
func (v *Twitter) UnmarshalJSON(data []byte) error {
	...
	easyjsonE23b537bDecodeGithubComTsukiyozDemosUsecasesJsonparser(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Twitter) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE23b537bDecodeGithubComTsukiyozDemosUsecasesJsonparser(l, v)
}
func easyjsonE23b537bDecode1(in *jlexer.Lexer, out *struct {
	Contributors interface{} `json:"contributors"`
	Coordinates  interface{} `json:"coordinates"`
	CreatedAt    string      `json:"created_at"`
	Entities     struct {
	...
	for !in.IsDelim('}') {
		...
		case "entities":
			easyjsonE23b537bDecode2(in, &out.Entities)
		case "favorited":
		...
		case "metadata":
			easyjsonE23b537bDecode3(in, &out.Metadata)
		case "place":
		...
		case "user":
			easyjsonE23b537bDecode4(in, &out.User)
		default:
			in.SkipRecursive()
		}
		in.WantComma()
...
func easyjsonE23b537bEncode1(out *jwriter.Writer, in struct {
	Contributors interface{} `json:"contributors"`
	Coordinates  interface{} `json:"coordinates"`
	CreatedAt    string      `json:"created_at"`
	Entities     struct {
	...
	}
	{
		...
		out.RawString(prefix)
		easyjsonE23b537bEncode2(out, in.Entities)
	}
	{
	...
	}
	{
		...
		out.RawString(prefix)
		easyjsonE23b537bEncode3(out, in.Metadata)
	}
	{
	...
	}
	{
		...
		out.RawString(prefix)
		easyjsonE23b537bEncode4(out, in.User)
	}
	out.RawByte('}')
}
func easyjsonE23b537bDecode4(in *jlexer.Lexer, out *struct {
	ContributorsEnabled bool   `json:"contributors_enabled"`
	CreatedAt           string `json:"created_at"`
	DefaultProfile      bool   `json:"default_profile"`
	DefaultProfileImage bool   `json:"default_profile_image"`
	...
	for !in.IsDelim('}') {
		...
		case "entities":
			easyjsonE23b537bDecode5(in, &out.Entities)
...
func easyjsonE23b537bEncode4(out *jwriter.Writer, in struct {
	ContributorsEnabled bool   `json:"contributors_enabled"`
	CreatedAt           string `json:"created_at"`
	DefaultProfile      bool   `json:"default_profile"`
	DefaultProfileImage bool   `json:"default_profile_image"`
	...
	}
	{
		const prefix string = ",\"entities\":"
		out.RawString(prefix)
		easyjsonE23b537bEncode5(out, in.Entities)
	}
	{
...
func easyjsonE23b537bDecode5(in *jlexer.Lexer, out *struct {
	Description struct {
		Urls []interface{} `json:"urls"`
	} `json:"description"`
	URL struct {
	...
	for !in.IsDelim('}') {
		...
		switch key {
		case "description":
			easyjsonE23b537bDecode6(in, &out.Description)
		case "url":
			easyjsonE23b537bDecode7(in, &out.URL)
		default:
			in.SkipRecursive()
		}
		in.WantComma()
...
func easyjsonE23b537bEncode5(out *jwriter.Writer, in struct {
	Description struct {
		Urls []interface{} `json:"urls"`
	} `json:"description"`
	URL struct {
	...
	_ = first
	{
		const prefix string = ",\"description\":"
		out.RawString(prefix[1:])
		easyjsonE23b537bEncode6(out, in.Description)
	}
	{
		const prefix string = ",\"url\":"
		out.RawString(prefix)
		easyjsonE23b537bEncode7(out, in.URL)
	}
	out.RawByte('}')
}
func easyjsonE23b537bDecode7(in *jlexer.Lexer, out *struct {
	Urls []struct {
		ExpandedURL interface{} `json:"expanded_url"`
		Indices     []int64     `json:"indices"`
		URL         string      `json:"url"`
...
func easyjsonE23b537bEncode7(out *jwriter.Writer, in struct {
	Urls []struct {
		ExpandedURL interface{} `json:"expanded_url"`
		Indices     []int64     `json:"indices"`
		URL         string      `json:"url"`
	...
	_ = first
	{
		...
		if in.Urls == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v5, v6 := range in.Urls {
				...
				easyjsonE23b537bEncode8(out, v6)
			}
			out.RawByte(']')
		}
	}
...
func easyjsonE23b537bDecode8(in *jlexer.Lexer, out *struct {
	ExpandedURL interface{} `json:"expanded_url"`
	Indices     []int64     `json:"indices"`
	URL         string      `json:"url"`
}) {
...
func easyjsonE23b537bEncode8(out *jwriter.Writer, in struct {
	ExpandedURL interface{} `json:"expanded_url"`
	Indices     []int64     `json:"indices"`
	URL         string      `json:"url"`
}) {
...
func easyjsonE23b537bDecode6(in *jlexer.Lexer, out *struct {
	Urls []interface{} `json:"urls"`
}) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
...
func easyjsonE23b537bEncode6(out *jwriter.Writer, in struct {
	Urls []interface{} `json:"urls"`
}) {
	out.RawByte('{')
	first := true
...
func easyjsonE23b537bDecode3(in *jlexer.Lexer, out *struct {
	IsoLanguageCode string `json:"iso_language_code"`
	ResultType      string `json:"result_type"`
}) {
	isTopLevel := in.IsStart()
...
func easyjsonE23b537bEncode3(out *jwriter.Writer, in struct {
	IsoLanguageCode string `json:"iso_language_code"`
	ResultType      string `json:"result_type"`
}) {
	out.RawByte('{')
...
func easyjsonE23b537bDecode2(in *jlexer.Lexer, out *struct {
	Hashtags []struct {
		Indices []int64 `json:"indices"`
		Text    string  `json:"text"`
	} `json:"hashtags"`
		...
		case "hashtags":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					easyjsonE23b537bDecode9(in, &v13)
...
func easyjsonE23b537bEncode2(out *jwriter.Writer, in struct {
	Hashtags []struct {
		Indices []int64 `json:"indices"`
		Text    string  `json:"text"`
	} `json:"hashtags"`
	...
	_ = first
	{
		...
		if in.Hashtags == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v16, v17 := range in.Hashtags {
				...
				easyjsonE23b537bEncode9(out, v17)
			}
			out.RawByte(']')
		}
	}
...
func easyjsonE23b537bDecode9(in *jlexer.Lexer, out *struct {
	Indices []int64 `json:"indices"`
	Text    string  `json:"text"`
}) {
	isTopLevel := in.IsStart()
...
func easyjsonE23b537bEncode9(out *jwriter.Writer, in struct {
	Indices []int64 `json:"indices"`
	Text    string  `json:"text"`
}) {
	out.RawByte('{')
...
func easyjsonE23b537bDecode(in *jlexer.Lexer, out *struct {
...
func easyjsonE23b537bEncode(out *jwriter.Writer, in struct {
	CompletedIn float64 `json:"completed_in"`
	Count       int64   `json:"count"`
	MaxID       int64   `json:"max_id"`
	MaxIDStr    string  `json:"max_id_str"`
